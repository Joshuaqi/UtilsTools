...
public class Hex {
    ...
    public static void main(String[] args) {
        String srcStr = "68 05 00 68 09 01 00 00 00 08 16";
    ...
    public static String hexStringToString(String hexString, int encodeType) {
        ...
        for (int i = 0; i < max; i++) {
            char c = (char) Hex.hexStringToAlgorism(hexString
    ...
    public static byte[] hexStringToByte(String hex) {
        ...
        String binarys = Hex.hexStringToBinary(hex);
        for (int i = 0; i < max; i++) {
            bytes[i] = (byte) Hex.binaryToAlgorism(binarys.substring(
                    i * 8 + 1, (i + 1) * 8));
